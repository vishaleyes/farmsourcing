...
msg['FNAME_VALIDATE']="من فضلك ادخل الاسم الأول";
msg['LNAME_VALIDATE']="من فضلك ادخل اسم العائلة";
...
msg['PHONE_VALIDATE']="Please specify email, phone or both";
msg['VPHONE_VALIDATE']="ليس رقم هاتف صالح";
msg['APHONE_VALIDATE']="Phone number is available to register";
msg['NAPHONE_VALIDATE']="Phone number not available to register";
msg['PASSWORD_VALIDATE']="من فضلك ادخل كلمة السر الصحيحة";
msg['VPASSWORD_VALIDATE']="كلمة السر يجب ان تكون أكبر من 6 أحرف";
msg['CPASSWORD_VALIDATE']="Please re-enter password";
msg['MPASSWORD_VALIDATE']="كلمة المرور و تأكيد كلمة المرور لا تتطابق";
...
msg['EMAIL_VALIDATE_VALID_ERROR_ACCOUNT_MANAGER']="غير صالح.";
msg['SUCCESS_EMAIL_VALIDATE_ACCOUNT_MANAGER']="المتاحة للتسجيل.";
...
msg['EMAIL_NOT_AVAILABLE_VALIDATE_ERROR']="لا تتوفر للتسجيل";
msg['PHONE_NOT_AVAILABLE_VALIDATE_ERROR']="لا تتوفر للتسجيل";
...
msg['PLCD']="Primary location cannot be deleted";
...
msg['ONLY_PHONE_VALIDATE']="يرجى إدخال رقم الهاتف";
...
msg['_RESTRIC_TO_CHANGE_EMAIL_']='استخدام حساب الهاتف لتغيير البريد الإلكتروني.';
...
msg['FIRST_NAME_REG_SPECIAL_CHARACTER']="لم أحرف خاصة";
msg['REMINDER_NAME_REG_SPECIAL_CHARACTER']="No special characters";
msg['REMINDER_LIST_ATLEAST_ONE']="Select atleast one list";

msg['LAST_NAME_REG']=/^[A-Za-z]*$/;
msg['LAST_NAME_REG_SPECIAL_CHARACTER']="لم أحرف خاصة";
...
msg["INVALID_FILE_EXTENSION"]="Invalid file extension";
msg['HEADER_HI']="مرحبا";
msg['INVALID_TOKEN']="صالح رمزية";
msg['TICKET_EMPTY']="تذكرة فارغة.";
msg['PRODUCT_QUANTITY_NOT_ENOUGH']="هذا المنتج لم كمية كافية.";
msg['ENTER_INVOICE_ID']="يرجى إدخال الرقم الفاتورة.";
msg['ENTERED_WRONG_INVOICE_ID']="دخلت كنت على خطأ رقم الفاتورة.";
msg['ENTER_UPC_CODE']="من فضلك ادخل رمز UPC.";
msg['PLEASE_ENTER_CORRECT_UPC_CODE']="من فضلك ادخل الصحيح UPC رمز.";
msg['PRODUCT_ALREADY_ADDED']="وأضاف المنتج بالفعل في التذكرة.";
msg['INSERT_ONE_VALUE']="يرجى إدراج ما لا يقل عن قيمة واحدة.";
msg['ENTER_ACC_TYPE']="من فضلك ادخل نوع الحساب.";
msg['RETURN_TICKET']="تذكرتك العودة هو متابعة.";
msg['ENTER_GROUP']="الرجاء اختيار اسم المجموعة.";
msg['ENTER_ACC_NAME']="من فضلك ادخل اسم الحساب.";
msg['SELECT_PRODUCT']="الرجاء اختيار المنتج.";
msg['SELECT_STORE']="الرجاء اختيار المخزن.";
msg['ADD_QUANTITY']="من فضلك ادخل الكمية.";
msg['NOT_AVAILABLE']="الكمية غير متوفرة.";
msg['SELECT_CUST']="الرجاء اختيار العملاء.";
msg['SELECT_PAY_TYPE']="الرجاء اختيار نوع الدفع.";
