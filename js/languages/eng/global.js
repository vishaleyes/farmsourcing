...
msg['VPHONE_VALIDATE']="is not a valid phone number";
...
msg['TICKET_EMPTY']="Ticket is Empty.";
msg['PRODUCT_QUANTITY_NOT_ENOUGH']="This product has not enough quantity.";
msg['ENTER_INVOICE_ID']="Please enter Invoice Id.";
msg['ENTERED_WRONG_INVOICE_ID']="You entered wrong Invoice Id.";
msg['ENTER_UPC_CODE']="Please enter UPC code.";
msg['PLEASE_ENTER_CORRECT_UPC_CODE']="Please enter correct UPC code.";
msg['PRODUCT_ALREADY_ADDED']="Product already added in the ticket.";

msg['INVITE_DELETED_SUCCESS']="Invite deleted successfully";
msg['ENTER_LIST_NAME']="Please enter list name";
msg['ENTER_INVOICE']="Please enter Invoice Id.";
msg['INSERT_ONE_VALUE']="Please insert at least one value.";
msg['ENTER_ACC_TYPE']="Please enter account type.";
msg['RETURN_TICKET']="Your Return Ticket is continue.";
msg['ENTER_GROUP']="Please select group name.";
msg['ENTER_ACC_NAME']="Please enter account name.";
msg['SELECT_PRODUCT']="Please select product.";
msg['SELECT_STORE']="Please select store.";
msg['ADD_QUANTITY']="Please enter quantity.";
msg['NOT_AVAILABLE']="Quantity not available.";
msg['SELECT_CUST']="Please select customer."; 
msg['SELECT_PAY_TYPE']="Please select payment type.";