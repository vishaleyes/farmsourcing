...
// CWebApplication properties can be configured here
	...
	$statusFlag=true;
	 ...
	 {	
		...
		else if(strtolower($result['controller'])=='pos')
		{
			$themename = 'pos';
	...
	'params'=>array(
		...
		'base_path'=>'http://'.WEB_HOST_NAME.'/farmsourcing/index.php?r=',
		'base_url'=>'http://'.WEB_HOST_NAME.'/farmsourcing/',
		'base_path_language'=>'http://'.WEB_HOST_NAME.'/farmsourcing/js/',
		'image_path'=>'http://'.WEB_HOST_NAME.'/farmsourcing/images',
		'msg'=>$msg,
		'adminmsg'=>$adminmsg,
		'errorCode'=>$errorCode,
