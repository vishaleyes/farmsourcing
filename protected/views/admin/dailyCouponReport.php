  <div class="widget">
    <div class="navbar">
      <div class="navbar-inner">
        <h6><a href="<?php echo Yii::app()->params->base_path;?>admin/showReports">Reports</a>&nbsp;&nbsp;<img src="<?php echo Yii::app()->params->base_url;?>images/path-arrow.png" alt="" border="0" />&nbsp;&nbsp;Daily Coupon Report</h6>
      </div>
    </div>
    <div class="well">
<form id="validate" action="<?php echo Yii::app()->params->base_path;?>admin/showMonthlyCouponReports" method="post" enctype="multipart/form-data">
      ...
      <?php if(isset($ext['type']) && $ext['type'] == 1) { ?>
      	<div class="widget">
                	<div class="navbar"><div class="navbar-inner"><h6>Customer wise report of this date: <b><?php echo $ext['fromDate']; ?></b>   <i>&nbsp;to&nbsp;</i>  <b><?php echo $ext['toDate']; ?></b></h6></div></div>
      ...
      <?php if(isset($ext['type']) && $ext['type'] == 2) { ?>
      	<div class="widget">
                	<div class="navbar"><div class="navbar-inner"><h6>Driver wise collection report between dates : <b><?php echo $ext['fromDate']; ?></b>   <i>&nbsp;to&nbsp;</i>  <b><?php echo $ext['toDate']; ?></b></h6></div></div>
                    <div class="table-overflow">
                        <table class="table table-bordered table-gradient" id="data-table">
                            <thead>
                                <tr>
