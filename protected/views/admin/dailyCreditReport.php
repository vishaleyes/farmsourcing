  <div class="widget">
    <div class="navbar">
      <div class="navbar-inner">
        <h6><a href="<?php echo Yii::app()->params->base_path;?>admin/showReports">Reports</a>&nbsp;&nbsp;<img src="<?php echo Yii::app()->params->base_url;?>images/path-arrow.png" alt="" border="0" />&nbsp;&nbsp;Daily Credit Report</h6>
      </div>
    </div>
    <div class="well">
<form id="validate" action="<?php echo Yii::app()->params->base_path;?>admin/showMonthlyCreditReports" method="post" enctype="multipart/form-data">
      <table width="90%" class="table table-striped table-bordered" id="data-table"  align="center" border="0" cellspacing="5" cellpadding="5" >
        <tr>
            <td width="25%">
