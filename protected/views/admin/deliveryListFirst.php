...
<form id="validate" onsubmit="return validateForm();" action="<?php echo Yii::app()->params->base_path;?>admin/deliverySlipstep2" method="post" enctype="multipart/form-data">
  <div class="widget">
    <div class="navbar">
      <div class="navbar-inner">
        <h6><a href="<?php echo Yii::app()->params->base_path;?>admin/generateDeliveryReport">Delivery List</a>&nbsp;&nbsp;<img src="<?php echo Yii::app()->params->base_url;?>images/path-arrow.png" alt="" border="0" /> Create Delivery Slip</h6>
      </div>
    </div>
    <div class="well">
      ...
      <div class="table-overflow">
        ...
        <thead>
          ...
          <th width="1%" align="center"><strong>ZoneId</strong></th>
          <th width="10%" align="center"><strong>ZoneName</strong></th>
          <th width="1%" align="center" ><strong>CustomerID</strong></th>
          <th width="10%" align="center"><strong>CustomerName</strong></th>
        ...
        <?php $i=1; foreach($zoneWiseData as $row) {  ?>
		 ...
		 <?php echo $row['customer_name']; ?>	
		  <?php /*?><input style="width:100%; height:30px; text-align:right;" type="text"  value="" class="textbox validate[required,custom[number]] text-input" name="rate1" readonly="readonly" onkeyup="calculateTotal(1);"  id="rate1" size="12"/><?php */?></td>
      ...
      <span id="error"></span>
        ...
        <button type="button" onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>admin/deliveryListing'" class="btn btn-large btn-danger">Cancel</button>
