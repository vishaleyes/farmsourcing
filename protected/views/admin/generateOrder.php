  ...
  <div class="widget">
    <div class="navbar">
      <div class="navbar-inner">
        <h6><a href="<?php echo Yii::app()->params->base_path;?>admin/salesOrderListing">Order List</a>&nbsp;&nbsp;<img src="<?php echo Yii::app()->params->base_url;?>images/path-arrow.png" alt="" border="0" />&nbsp;&nbsp;Create New Order</h6>
      </div>
    </div>
    <div class="well">
      ...
      <table width="80%" border="1" align="center" cellpadding="2" cellspacing="2" name="purchaseTable" id="purchaseTable">
        ...
        <tr id="tabletr1">
          ...
          <td><input style="width:100%; height:30px; text-align:center;" type="text" class="textbox text-input" value=""  name="rate1" id="rate1" readonly="readonly" /></td>
          <td align="center">
