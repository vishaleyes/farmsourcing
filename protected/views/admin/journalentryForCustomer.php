...
<!-- Default form -->
<form id="validate" action="<?php echo Yii::app()->params->base_path;?>admin/addGeneralEntryforCustomer" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
<div class="widget">
...
<div class="well">
    ...
    <div class="control-group">
        ...
        <div class="controls">
                <select data-placeholder="Choose a customer..." name="customer_id" id="customer_id" class="validate[required] styled" tabindex="">
