<!-- Span 12 -->
    <div class="widget">
        <div class="navbar">
            <div class="navbar-inner"><h6>Set New Password</h6></div>
        </div>
        <!-- Default form -->
<form id="validate" action="<?php echo Yii::app()->params->base_path;?>admin/setNewPasswordOfUser" method="post" enctype="multipart/form-data">
    <div class="widget">
    <div class="well">
