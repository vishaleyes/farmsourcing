			...
			<div class="sidebar-tabs">
		        ...
		        <div id="general">
			        ...
			        <ul class="navigation widget">
                     ...
                     <?php if(Yii::app()->session['type'] == 0 || Yii::app()->session['type'] == 4 || Yii::app()->session['type'] == 2  || Yii::app()->session['type'] == 3  || Yii::app()->session['type'] == 1 ) {  ?>
                        <li <?php if(isset(Yii::app()->session['current']) && Yii::app()->session['current'] == "orders") { ?>class="active"<?php } ?>><a href="<?php echo Yii::app()->params->base_path; ?>admin/salesOrderListing" title="See All Order List"><i class="icon-th"></i>Sales Orders</a></li>
                      	...
                      	<?php if(Yii::app()->session['type'] == 0 || Yii::app()->session['type'] == 4 ) {  ?>  
                      ...
                      <?php } ?>
                       ...
                       <?php if(Yii::app()->session['type'] == 0 || Yii::app()->session['type'] == 4 || Yii::app()->session['type'] == 3 ) {  ?>
                       ...
                       <?php } ?>
                        ...
                        <?php if(Yii::app()->session['type'] == 0 || Yii::app()->session['type'] == 4 || Yii::app()->session['type'] == 2  || Yii::app()->session['type'] == 3 ) {  ?> 
                        ...
                        <?php } ?>
                        <?php if(Yii::app()->session['type'] == 0 || Yii::app()->session['type'] == 4 || Yii::app()->session['type'] == 2) {  ?> 
                        ...
                        <li <?php if(isset(Yii::app()->session['current']) && Yii::app()->session['current'] == "Promo Codes") { ?>class="active"<?php } ?>><a href="<?php echo Yii::app()->params->base_path; ?>admin/promoCodesListing" title="Promo Codes Allocation"><i class="icon-reorder"></i>Promo Codes<!--<strong>3</strong>--></a>
			            </li>
                        <?php } ?>
                        
                           <?php if(Yii::app()->session['type'] == 0 || Yii::app()->session['type'] == 4  || Yii::app()->session['type'] == 1 ) {  ?>
                         <li <?php if(isset(Yii::app()->session['current']) && Yii::app()->session['current'] == "PO Generation") { ?>class="active"<?php } ?>><a href="<?php echo Yii::app()->params->base_path; ?>admin/purchaseOrderListing" title="PO Generation"><i class="icon-indent-right"></i>PO/GRN List</a>
			            </li>
                       <?php } ?>
