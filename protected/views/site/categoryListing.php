        ...
        <ul class="nav nav-pills pull-right">
          <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" href="#a"> Sort by <i class="fa fa-sort fa-fw"></i> </a>
            <ul class="dropdown-menu" role="menu">
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "c.category_name" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?> ><a href="<?php echo Yii::app()->params->base_path;?>site/categoryListing/sortBy/c.category_name/sortType/asc">Name (A-Z)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "c.category_name" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/categoryListing/sortBy/c.category_name/sortType/desc">Name (Z-A)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "c.createdAt") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/categoryListing/sortBy/c.createdAt/sortType/desc">Recent</a></li>
            </ul>
          </li>
        </ul>
      </div>
            ...
            <!-- Product --> 
             <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="producttitle">
                <h1><a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php echo $row['cat_id'] ?>"  data-toggle="tooltip"  title="See all products of this category"><?php echo $row['category_name']; ?></a></h1>
              </div>
