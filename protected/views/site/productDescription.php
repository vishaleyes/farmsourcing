<?php 
	...
	if($productData_discount != "")
	{
		...
		if($productData_todayDate >= $productData_fromDate && $productData_todayDate <= $productData_toDate)
		{
			...
			$productData_finalProductAmount = $productData['product_price'];
...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div class="breadcrumb"> <a href="<?php echo Yii::app()->params->base_path;?>site"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="<?php echo Yii::app()->params->base_path;?>site/productDescription/id/<?php echo $productData['product_id']; ?>"> Product </a> </div>
              ...
              <div class="product-btns-wr col-md-8 col-sm-8 col-xs-12">
                <div class="product-btns">
                  <div class="product-big-btns">
                    <button class="btn btn-addtocart" onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>site/addToCart/id/<?php echo $productData['product_id']; ?>'"> <i class="fa fa-shopping-cart fa-fw"></i> Add to Cart </button>
                  </div>
                </div>
              </div>
            </div>
     ...
     <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 box-block sidebar">
      ...
      <div class="box-content">
        <div class="box-products slide carousel-fade" id="productc2">
          ...
          <?php $i=0;foreach($specialProductData as $row) { 
            ...
            <?php } ?>
              ...
              <div class="product-block">
                ...
                <div class="product-meta">
                  <div class="name"><a href="<?php echo Yii::app()->params->base_path;?>site/productDescription/id/<?php echo $row['product_id']; ?>"><?php echo $row['product_name']; ?></a> / <div class="rating" style="color:#FFF;"><?php echo $row['unit_name']; ?> </div></div>
          ...
          <div class="carousel-inner"> 
            ...
            <div class="item active">
              <div class="row box-product"> 
               <?php foreach($relatedProductData1 as $row) { 
			    if($row['cat_is_discount'] == 1)
					{
						if($row['is_discount'] == 1)
						{
                  ...
                  <?php 
                   ...
                   ?> 
                    ...
                    <div class="product-meta">
                      ...
                      <div class="big-price"> <span class="price-new"><span class="sym">&#8377;</span><?php echo $finalProductAmount; ?></span><?php echo $oldAmountText ; ?></div>
                      <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="">View</a> <a class="btn btn-default btn-addtocart pull-right" href="<?php echo Yii::app()->params->base_path;?>site/addToCart/id/<?php echo $row['product_id']; ?>">Add to
                        Cart</a> </div>
            ...
            <div class="item">
              <div class="row box-product"> 
                 <?php foreach($relatedProductData2 as $row) { 
