        ...
        <ul class="nav nav-pills pull-right">
          <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" href="#a"> Sort by <i class="fa fa-sort fa-fw"></i> </a>
            <ul class="dropdown-menu" role="menu">
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_name" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/asc/sortBy/p.product_name">Name (A-Z)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_name" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_name">Name (Z-A)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_price" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/asc/sortBy/p.product_price">Price (Low-High)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_price" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_price">Price (High-Low)</a></li>
             
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_id" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_id">Recent</a></li>
            </ul>
          </li>
          <li class="view-list"> <a href="<?php echo Yii::app()->params->base_path;?>site/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>"> <i class="fa fa-list-ul fa-fw"></i></a> </li>
          <li class="view-grid active"> <a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>"> <i class="fa fa-th-large fa-fw"></i></a> </li>
        </ul>
      </div>
