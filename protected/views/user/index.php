          ...
          <div class="carousel-inner"> 
            ...
            <div class="item active">
              <div class="row box-product"> 
               ...
               <?php foreach($featureProductData1 as $row) { 
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                  <div class="product-block">
                   ...
                   $content = file_get_contents(Yii::app()->params->base_url."assets/upload/product/".$row['product_image']);
                    ...
                    ?> 
                      <img alt="<?php echo $row['product_name']; ?>" src="<?php echo Yii::app()->params->base_url; ?>assets/upload/product/<?php echo $filePath; ?>" title="<?php echo $row['product_name']; ?>" style="width:100%; height:255px;">
            ...
            <!-- Items Row -->
             <div class="item">
              <div class="row box-product"> 
               ...
               <?php foreach($featureProductData2 as $row) { 
            ...
            <?php } ?>
              <div class="product-block">
                ...
                <div class="product-meta">
                  <div class="name"><a href="<?php echo Yii::app()->params->base_path;?>user/productDescription/id/<?php echo $row['product_id']; ?>"><?php echo $row['product_name']; ?></a></div>
                  <div class="big-price"> <span class="price-new"><span class="sym">&#8377;</span><?php echo $finalProductAmount; ?></span><?php echo $oldAmountText ; ?> </div>
                  <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="<?php echo Yii::app()->params->base_path;?>user/productDescription/id/<?php echo $row['product_id']; ?>">View</a> <a class="btn btn-default btn-addtocart pull-right" href="">Add to
                    Cart</a> </div>
                </div>
                <div class="meta-back"></div>
              </div>
        ...
        <div class="box-products slide" id="productc3">
          ...
          <div class="carousel-inner"> 
            ...
            <div class="item">
			    <div class="row box-product"> 
                <?php 
					$i=0;foreach($recentProductData2 as $row) {
