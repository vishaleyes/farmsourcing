...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      <div class="breadcrumb"> <a href="<?php echo Yii::app()->params->base_path;?>site"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="<?php echo Yii::app()->params->base_path;?>site/productListingGrid"> Product List </a> </div>
      ...
      <?php } ?>
        <ul class="nav nav-pills pull-right">
          ...
          <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" href="#a"> Sort by <i class="fa fa-sort fa-fw"></i> </a>
           <ul class="dropdown-menu" role="menu">
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_name" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/asc/sortBy/p.product_name">Name (A-Z)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_name" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_name">Name (Z-A)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_price" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/asc/sortBy/p.product_price">Price (Low-High)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_price" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_price">Price (High-Low)</a></li>
             
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_id" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_id">Recent</a></li>
            </ul>
          </li>
          <li class="view-list"> <a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>"> <i class="fa fa-list-ul fa-fw"></i></a> </li>
          <li class="view-grid active"> <a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>"> <i class="fa fa-th-large fa-fw"></i></a> </li>
        </ul>
      </div>
      ...
      <div class="box-content">
        <div class="box-products"> 
		  ...
		  $i=1;
			...
			if($cnt>0){
		 // print "<pre>";print_r($data['productlisting']);exit;
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div class="product-block">
                <div class="image">
                  ...
                  <?php 
                   ...
                   $content = file_get_contents(Yii::app()->params->base_url."assets/upload/product/".urlencode($row['product_image']));
                    ...
                    ?> 
                  <img alt="<?php echo $row['product_name']; ?>" src="<?php echo Yii::app()->params->base_url; ?>assets/upload/product/<?php echo $filePath; ?>" title="<?php echo $row['product_name']; ?>" style="width:100%;height:255px;"></a> </div>
                <div class="product-meta">
                  ...
                  <div class="big-btns"> <a class="btn btn-default btn-view pull-left" href="<?php echo Yii::app()->params->base_path;?>user/productDescription/id/<?php echo $row['product_id']; ?>">View</a> <a class="btn btn-default btn-addtocart pull-right" href="<?php echo Yii::app()->params->base_path;?>user/addToCart/id/<?php echo $row['product_id']; ?>">Add to
                    Cart</a> </div>
