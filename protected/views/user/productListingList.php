      ...
      <?php } ?>
          ...
          <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" href="#a"> Sort by <i class="fa fa-sort fa-fw"></i> </a>
            <ul class="dropdown-menu" role="menu">
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_name" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/asc/sortBy/p.product_name">Name (A-Z)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_name" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_name">Name (Z-A)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_price" && $ext['sortType'] == "asc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/asc/sortBy/p.product_price">Price (Low-High)</a></li>
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_price" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_price">Price (High-Low)</a></li>
             
              <li <?php if(isset($ext['sortBy']) && $ext['sortBy'] == "p.product_id" && $ext['sortType'] == "desc") { ?> class="active" <?php } ?>><a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>/sortType/desc/sortBy/p.product_id">Recent</a></li>
            </ul>
          </li>
          <li class="view-list active"> <a href="<?php echo Yii::app()->params->base_path;?>user/productListingList/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>"> <i class="fa fa-list-ul fa-fw"></i></a> </li>
          <li class="view-grid"> <a href="<?php echo Yii::app()->params->base_path;?>user/productListingGrid/cat_id/<?php if(isset($_GET['cat_id']) && $_GET['cat_id'] ) { echo $_GET['cat_id'] ; } ?>"> <i class="fa fa-th-large fa-fw"></i></a> </li>
        </ul>
      </div>
          ...
          <div class="row list-product"> 
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 product-image">
              <div class="image">
                ...
                <img alt="<?php echo $row['product_name']; ?>" src="<?php echo Yii::app()->params->base_url; ?>assets/upload/product/<?php echo $filePath; ?>" title="<?php echo $row['product_name']; ?>" style="width:276px; height:250px;" class="ani-image"></a> </div>
            </div>
            <!-- end: Image -->
            ...
            <div class="col-md-5 col-sm-8 col-xs-12 product-meta">
              <div class="productmeta">
                <p><?php echo substr($row['product_desc'],0,100); ?> <a href="<?php echo Yii::app()->params->base_path;?>user/productDescription/id/<?php echo $row['product_id']; ?>">read more</a></p>
                <div class="category-list-btns">
                  <button class="btn normal btn-addtocart pull-left" onclick="window.location.href='<?php echo Yii::app()->params->base_path;?>user/addToCart/id/<?php echo $row['product_id']; ?>'"> <i class="fa fa-shopping-cart fa-fw"></i> Add to Cart </button>
                </div>
              </div>
            </div>
          </div>
